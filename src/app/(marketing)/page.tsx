  ...
  return (
    <>
      ...
      <section className="bg-primary text-primary-foreground">
        {/* too make contents spaced out better, wrap in div */}
        <div className="container py-16 flex flex-col gap-16 px-8 md:px-16">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 xl:grid-cols-5 gap-16">
            ...
            {/* to hide the last icon when at certain screens so it looks more balanced */}
  ...
  return (
    <Card>
      ...
      <CardFooter className="flex flex-col gap-4 items-start">
        ...
        <Feature>SaaS Pass Discounts</Feature>
        {canAccessAnalytics && <Feature>Advance analytics</Feature>}
        {canCustomizeBanner && <Feature>Banner customization</Feature>}
        {canRemoveBranding && <Feature>Remove SaaS Pass branding</Feature>}
      </CardFooter>
    </Card>
  );
}
