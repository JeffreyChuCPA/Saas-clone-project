...
CREATE INDEX "user_subscription.clerk_user_id_index" ON "user_subscription" USING btree ("clerk_user_id");--> statement-breakpoint
CREATE INDEX "user_subscription.stripe_customer_id_index" ON "user_subscription" USING btree ("stripe_customer_id");