...
async function updateCountryGroups() {
  ...
  //insert into db all data from the hard coded json file, if duplicates then make sure to update the recommenedDiscountPercentage value
  //basically it just updates the data in the DB, if name is duplicate, updated the recommendedDiscountPercentage with the inserted data value
